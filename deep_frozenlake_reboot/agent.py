...
class Agent:
    ...
    def __init__(self, alpha_learn_rate, gamma_discount_rate, 
        ...
        #self.input_layer = tf.placeholder(shape=[None, 1], dtype=tf.float32)
    ...
    def learn(self, state, action, next_state, reward):
        ...
        #print("Valores ANTES da otimização: " + str(qsa_values))
        ...
        #print("Valores REAIS ANTES da otimização: " + str(qsa_values))
        ...
        #print("Valores DEPOIS da otimização: " + str(qsa_values))
